...
class HealthCheck {
    ...
    constructor() {
        ...
        const application_subscriber = myriad.subscribe([constants.myriad.APPLICATION_PREFIX, application_name].join(constants.myriad.DELIMITER));
        const containers_subscriber = myriad.subscribe([constants.myriad.CONTAINERS_PREFIX, application_name, '*'].join(constants.myriad.DELIMITER));
